...
endpoint information, and optionally health-checks each endpoint
to determine which models are actually reachable.
"""
...
def discover_endpoints(
    ...
    4. Parallel health checks via GET ``/v1/models``.
    5. Return list with ``healthy`` flag set.
